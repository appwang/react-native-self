...
import com.chemao.base.choose.bean.CarModelInfo;
...
public class ChooseCarModelAdapter extends BaseAdapter {
	...
	private ArrayList<CarModelInfo.ModelsEntity> mlist;
	private LayoutInflater mInflater;
	private Context mcontext;
	private int selectPosition=-1;
	public ChooseCarModelAdapter(Context context, ArrayList<CarModelInfo.ModelsEntity> items) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		CarModelInfo.ModelsEntity carModels = mlist.get(position);
		if (carModels != null) {
			viewHolder.brandName.setText(""+ carModels.getName());
