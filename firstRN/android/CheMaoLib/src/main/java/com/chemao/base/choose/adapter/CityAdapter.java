...
public class CityAdapter extends BaseAdapter {
	...
	public CityAdapter(Context context, ArrayList<CityInfo.CitysEntity> items) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		CityInfo.CitysEntity provinceBean = mlist.get(position);
		if (provinceBean != null) {
			viewHolder.brandName.setText(""+provinceBean.getName());
		}
